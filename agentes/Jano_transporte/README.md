...
Los errores salen siempre en JSON con el formato común de los agentes
(`{"error": true, "codigo": ..., "mensaje": ...}`, más `detail` por
compatibilidad con la web de demostración) — nunca la página HTML de Flask.
